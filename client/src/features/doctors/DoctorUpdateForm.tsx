...
function DoctorUpdateForm({
  ...
  return (
    <form onSubmit={update}>
      ...
      <div className="mb-6"><input name="photo" type="file" onChange={handleFileChange} /></div>
      <div className="mb-6"><input name="slot" type="text" value={slot} onChange={(e) => setSlot(Number(e.target.value))} /></div>
      <div className="main_link_button w-80 h-14"><button className="save" type="submit">
        сохранить изменения
      </button></div>
    </form>
  );
